...
[![Mis à jour](https://img.shields.io/badge/Mis_à_jour_le-03_09_2026-lightgrey)](https://github.com/Alweddle/solar-dashboard)
...
| ⚡ Production | **13.8 kWh** |
| 💶 Gain | **2.96 €** |
| ♻️ Taux d'autoconsommation | **60 %** |

### 📈 Depuis le 01/08/2024
| Métrique | Valeur |
|---|---|
| ⚡ Production cumulée | **9 486 kWh** |
| 💶 Gains cumulés | **1 775 €** |
...
*README généré automatiquement le 03/09/2026 via Google Apps Script* 🤖
