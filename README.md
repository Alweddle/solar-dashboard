...
[![Mis à jour](https://img.shields.io/badge/Mis_à_jour_le-26_07_2026-lightgrey)](https://github.com/Alweddle/solar-dashboard)
...
| ⚡ Production | **9.2 kWh** |
| 💶 Gain | **2.36 €** |
| ♻️ Taux d'autoconsommation | **90 %** |

### 📈 Depuis le 01/08/2024
| Métrique | Valeur |
|---|---|
| ⚡ Production cumulée | **8 758 kWh** |
| 💶 Gains cumulés | **1 626 €** |
...
*README généré automatiquement le 26/07/2026 via Google Apps Script* 🤖
